        ...
        <div className="notfoundcontainer">
          ...
          <div className="rightsidediv">
            <div className="404text">
              <img
                src={errortext}
                className="fourofourtext"
                alt=""
              />
            </div>
            <div className="four-o-fourmessage">
              <p className="error-messagee">The page you are trying to access does not exist</p>
            </div>
            <div className="reload-button">
              <button className='reload-page' type='button'>Reload page</button>
            </div>
          </div>
        </div>
      </div>
